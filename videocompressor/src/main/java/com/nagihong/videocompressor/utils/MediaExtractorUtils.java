...
public class MediaExtractorUtils {
    ...
    public static class TrackResult {
        ...
        public void log() {
            Log.d(TrackResult.class.getName(), String.format("videoTrackIndex: %d, videoTrackMime: %s, videoTrackFormat: %b",
                    mVideoTrackIndex, mVideoTrackMime, null != mVideoTrackFormat));
            Log.d(TrackResult.class.getName(), String.format("audioTrackIndex: %d, audioTrackMime: %s, audioTrackFormat: %b",
                    mAudioTrackIndex, mAudioTrackMime, mAudioTrackFormat));
        }
    }
